...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
    <h2>P05 DDL of Artists To CGV of Albums By ArtistId</h2>
    </div>
    <br />
    <div class="row">
    ...
    <div class="row">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSource2" AllowPaging="True" PageSize="5" PagerSettings-Mode="NumericFirstLast" GridLines="Horizontal" EnableViewState="True" CssClass="table table-striped" BorderStyle="None" EmptyDataText="No Data Available">
            <Columns>
